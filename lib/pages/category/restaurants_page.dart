...
class _RestaurantsPageState extends State<RestaurantsPage> {
  ...
  final List<MapItem> pointsOfInterest = [
    MapItem(
      id: '1',
      title: 'Restaurante Sa Sínia',
      description: 'Descripción del Restaurante Sa Sínia',
      position: LatLng(39.4697, 3.1483),
      imageUrl:
          'https://felanitx.drupal.auroracities.com/sites/default/files/2024-10/CalaSerena01.jpg',
      categoryId: 1,
      categoryName: 'Bares',
      averageRating: 4.2,
      commentCount: 18,
    ...
    MapItem(
      id: '2',
      title: 'Bar Cala Ferrera',
      description: 'Descripción del Bar Cala Ferrera',
      position: LatLng(39.4597, 3.1383),
      imageUrl:
          'https://felanitx.drupal.auroracities.com/sites/default/files/2024-10/CalaFerrera01_1.jpg',
      categoryId: 1,
      categoryName: 'Bares',
      averageRating: 4.0,
      commentCount: 14,
